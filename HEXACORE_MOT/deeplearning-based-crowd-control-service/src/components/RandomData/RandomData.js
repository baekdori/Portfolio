...
app.get('/insertData', (req, res) => {
    ...
    const startTime = moment.tz('2024-08-22 09:00:00', 'YYYY-MM-DD HH:mm:ss', 'Asia/Seoul'); // 시작 시간 설정
    const endTime = moment.tz('2024-08-22 18:01:00', 'YYYY-MM-DD HH:mm:ss', 'Asia/Seoul'); // 종료 시간 설정
